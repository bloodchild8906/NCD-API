...
public class TicketDetailsService : ITicketDetailsService
{
    ...
    {
        var data = await _unitOfWork.TicketDetailsRepository.FindBy(ticketDetails =>
            !ticketDetails.IsDeleted && ticketDetails.Id == id);
    ...
    {
        var existingData =
            await _unitOfWork.TicketDetailsRepository.FindBy(details =>
                details.Id == ticketDetails.Id && !details.IsDeleted);
    ...
    {
        var existingData =
            await _unitOfWork.TicketDetailsRepository.FindBy(ticketDetails =>
                ticketDetails.Id == id && !ticketDetails.IsDeleted);
