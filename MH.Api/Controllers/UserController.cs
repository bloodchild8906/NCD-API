...
public class UserController : BaseController
{
    ...
    {
        if (!await _userService.IsAdmin(_currentUser.User.Id)) return Forbid("Not authorized to add user");
    ...
    {
        if (!await _userService.IsAdmin(_currentUser.User.Id)) return Forbid("Not authorized to get users");
        var users = await _userManager.Users
            ...
            .Select(user => new User
            {
                ...
                ContactDataTypeId = user.UserProfile.ContactDetails != null
                    ? user.UserProfile.ContactDetails.ContactDataTypeId
                    : null,
                ContactDataTypeName =
                    user.UserProfile.ContactDetails != null ? user.UserProfile.ContactDetails.Name : null,
                ContactTypeId = user.UserProfile.ContactDetails != null
                    ? user.UserProfile.ContactDetails.ContactTypeId
                    : null,
                ContactTypeName = user.UserProfile.ContactDetails != null ? user.UserProfile.ContactDetails.Name : null,
                ContactEntityId = user.UserProfile.ContactDetails != null
                    ? user.UserProfile.ContactDetails.ContactEntityId
                    : null,
                ContactEntityName =
                    user.UserProfile.ContactDetails != null ? user.UserProfile.ContactDetails.Name : null,
    ...
    {
        if (!await _userService.CanViewOrEdit(id)) return Forbid("Not authorized to get user");
    ...
    {
        if (!await _userService.CanViewOrEdit(user.Id)) return Forbid("Not authorized to update password");
    ...
    {
        if (!await _userService.IsAdmin(_currentUser.User.Id)) return Forbid("Not authorized to delete user");
    ...
    public async Task<IActionResult> ChangePassword(ChangePasswordModel changePasswordModel)
    {
        ...
        await _userManager.ChangePasswordAsync(user, changePasswordModel.CurrentPassword,
